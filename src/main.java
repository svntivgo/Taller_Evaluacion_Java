...
//        ejercicio3.calcular();
        ...
        /**
         * Este ejercicio contempla el punto 4 del taller
         */
        PrecioIVA ejercicio4 = new PrecioIVA();
//        ejercicio4.calcular();

        /**
         * Este ejercicio contempla el punto 5 del taller
         */
        ParImpar ejercicio5 = new ParImpar();
//        ejercicio5.mostrarWhile();

        /**
         * Este ejercicio contempla el punto 6 del taller
         */
        ParImpar ejercicio6 = new ParImpar();
//        ejercicio6.mostrarFor();

        /**
         * Este ejercicio contempla el punto 7 del taller
         */
        MayorIgualCero ejercicio7 = new MayorIgualCero();
//        ejercicio7.comprobar();

        /**
         * Este ejercicio contempla el punto 8 del taller
         */
        DiaLaboral ejercicio8 = new DiaLaboral();
//        ejercicio8.comprobar();

        /**
         * Este ejercicio contempla el punto 9 del taller
         */
        Frase ejercicio9 = new Frase();
//        ejercicio9.modificar();

        /**
         * Este ejercicio contempla el punto 10 del taller
         */
        Frase ejercicio10 = new Frase();
//        ejercicio10.elimnarEspacios();

        /**
         * Este ejercicio contempla el punto 11 del taller
         */
        Frase ejercicio11 = new Frase();
//        ejercicio11.contabilizar();

        /**
         * Este ejercicio contempla el punto 12 del taller
         */
        Frase ejercicio12 = new Frase();
//        ejercicio12.comparar();

        /**
         * Este ejercicio contempla el punto 13 del taller
         */
        Fecha ejercicio13 = new Fecha();
//        ejercicio13.consultar();

        /**
         * Este ejercicio contempla el punto 14 del taller
         */
        Contador ejercicio14 = new Contador();
//        ejercicio14.contar();

        /**
         * Este ejercicio contempla el punto 15 del taller
         */
